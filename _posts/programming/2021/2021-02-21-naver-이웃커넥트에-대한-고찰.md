...
'이웃.그룹 관리'메뉴로 들어왔다. 중간에 열린이웃(RSS)추가 버튼을 눌러준다.
...
ecrire06.github.io 추가 전
<center><img src="https://drive.google.com/uc?export=view&id=1bWH62wRX6VTABCCnxuv_8BOL-70Hg6Eq" width="100%" height="100%"></center>
ecrire06.github.io 추가 후

위의 사진처럼 ecrire06.github.io의 새 글이 네이버 이웃새글에 등장한다. 실시간으로 업로드되지는 않고 몇시간 정도 시간차가 있는 듯하다.